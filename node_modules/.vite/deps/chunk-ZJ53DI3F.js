...
function deepClone(source) {
  if (React15.isValidElement(source) || (0, import_react_is2.isValidElementType)(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React15.isValidElement(source[key]) || (0, import_react_is2.isValidElementType)(source[key])) {
...
//# sourceMappingURL=chunk-ZJ53DI3F.js.map
