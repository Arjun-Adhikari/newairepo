...
// aws auth
const AwsAuthLogin = Loadable(lazy(() => import('pages/auth/auth0/aws/login')));
const AwsAuthRegister = Loadable(lazy(() => import('pages/auth/auth0/aws/register')));
const AwsAuthForgotPassword = Loadable(lazy(() => import('pages/auth/auth0/aws/forgot-password')));
const AwsAuthResetPassword = Loadable(lazy(() => import('pages/auth/auth0/aws/reset-password')));
const AwsAuthCodeVerification = Loadable(lazy(() => import('pages/auth/auth0/aws/code-verification')));
const AwsAuthCheckMail = Loadable(lazy(() => import('pages/auth/auth0/aws/check-mail')));
